...
Formulating documentation structure is quite visual and handily reflected on the sidebar. All you need are two types of objects: `group`s and `page`s (*a few more exist, see [API reference](/#/docs/reference/api-reference)*). `group`s will enable you to organise indent or space out your content while `page`s represent documentation endpoints.
...
>
<Frame>
  <ShardDocs title="Basic example" basePath="/examples/sidebar-structure-basic" source={[
    { title: "Mangos", document: <h1>Mangos</h1> },
    { title: "Plums", document: <h1>Plums</h1> },
    { title: "Avacadoes", document: <h1>Avacadoes</h1> }
  ]} />
...
/>`}
  >
  <Frame>
    <ShardDocs title="Groups example" basePath="/examples/sidebar-structure-groups" source={[
      { title: "Camels", document: <h1>Camels</h1> },
      { title: "Hippos", document: <h1>Hippos</h1> },
      { title: "Baboons", document: <h1>Baboons</h1> },
      {
